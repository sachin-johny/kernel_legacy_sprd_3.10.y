 ...
 * 				 contiguous
 * @ION_HEAP_TYPE_CARVEOUT_BUDDY: same as above, but uses buddy allocator
...
#define ION_HEAP_CARVEOUT_BUDDY_MASK	(1 << ION_HEAP_TYPE_CARVEOUT_BUDDY)
