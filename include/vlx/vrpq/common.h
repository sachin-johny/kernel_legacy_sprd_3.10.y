...
#define VRPQ_PROF_REQS_FREE		20
#define VRPQ_PROF_REQS_PER_FREE		21
#define VRPQ_PROF_REQ_RING_FULL		22
#define VRPQ_PROF_PARAM_RING_FULL	23
#define VRPQ_PROF_WAIT_FOR_SPACE_INTR	24
#define VRPQ_PROF_PROC_STAT_TBL		25
