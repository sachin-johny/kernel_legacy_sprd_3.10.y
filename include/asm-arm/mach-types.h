...
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_HISENSE
# endif
# define machine_is_hisense()	(machine_arch_type == MACH_TYPE_HISENSE)
#else
# define machine_is_hisense()	(0)
#endif
