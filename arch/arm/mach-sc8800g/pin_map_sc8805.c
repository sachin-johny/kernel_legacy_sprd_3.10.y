...
//  | Pin Register        |   DS    | Func PU/PD | Func Select  | Slp PU/PD | Sleep OE/IE | 
    ...
    {PIN_KEYOUT5_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_O_EN ) },    // 0x100  NC 
    {PIN_KEYOUT6_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_I_EN ) },    // 0x100  GPIO26 TEST POINT  
    {PIN_KEYOUT7_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPU_EN | PIN_O_EN ) },    // 0x100  fm_32k   
    ...
    {PIN_KEYIN5_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_I_EN ) },    // 0x180  NC  
    {PIN_KEYIN6_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_I_EN ) },    // 0x180  NC
    {PIN_KEYIN7_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_I_EN ) },    // 0x180  NC 
    {PIN_SPI_DI_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN ) },    // 0x18A  CMMB WIFI SPIDO  
    {PIN_SPI_CLK_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN ) },    // 0x106  SPICLK  
    {PIN_SPI_DO_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN ) },    // 0x10A  CMMB WIFI SPIDI  
    {PIN_SPI_CSN0_REG,   ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPX_EN | PIN_Z_EN ) },    // 0x10A  SPI CS0: WIFI  
    {PIN_SPI_CSN1_REG,   ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPX_EN | PIN_Z_EN ) },    // 0x106  SPI CS1: CMMB  
    {PIN_MTDO_REG,       ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN ) },    // 0x101  JTAG  
    {PIN_MTDI_REG,       ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_O_EN ) },    // 0x18A  JTAG  
    {PIN_MTCK_REG,       ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_O_EN ) },    // 0x18A  JTAG  
    ...
    {PIN_EMCS_N2_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    NC
    {PIN_EMCS_N3_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    NC
    ...
    {PIN_CCIRRST_REG ,   ( PIN_DS_0 | PIN_SPX_EN | PIN_FUNC_3   | PIN_FPX_EN | PIN_O_EN) },    //  CAMERA_Reset
    ...
    {PIN_CLK_AUX0_REG,   ( PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_O_EN ) },    // 0x106   CLKAUX0, 32KHz for FM
    ...
    {PIN_RFCTL3_REG,     ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3   | PIN_SPD_EN | PIN_O_EN ) },    // 0x100   GPIO93 CMMB_INT 
    {PIN_RFCTL4_REG,     ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF   | PIN_SPX_EN | PIN_Z_EN ) },    // 0x100   GPIO94 CMMB_RSTN    
    {PIN_RFCTL5_REG,     ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x100   TD PA EN
    {PIN_RFCTL6_REG,     ( PIN_DS_2 | PIN_FPD_EN | PIN_FUNC_3   | PIN_SPD_EN | PIN_O_EN ) },    // 0x100   SPK PA EN
    ...
    {PIN_RFCTL9_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPX_EN | PIN_O_EN ) },    // 0x100   NC
    ...
    {PIN_RFCTL13_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN ) },    // 0x100   RF SWITCH VC1
    {PIN_RFCTL14_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN ) },    // 0x100   RF SWITCH VC2 
    {PIN_RFCTL15_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x100   RF SWITCH VC4 
    {PIN_XTL_EN_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPX_EN | PIN_O_EN ) },    // 0x101   GPIO106_WIFI/BT LOD EN
    ...
    {PIN_GPIO135_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100   CMMB Power   
    {PIN_GPIO136_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },    // 0x100    
    {PIN_GPIO137_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    
    {PIN_GPIO138_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    
    {PIN_GPIO139_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },    // 0x100    
    {PIN_GPIO140_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    
    {PIN_GPIO141_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_I_EN ) },    // 0x100    
    //origin {PIN_GPIO142_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN ) },    // 0x100    
    {PIN_GPIO142_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    
    {PIN_GPIO143_REG,    ( PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_1 | PIN_SPX_EN | PIN_Z_EN ) },    // 0x100    
    {PIN_GPIO144_REG,    ( PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_1 | PIN_SPX_EN | PIN_Z_EN ) },    // 0x100    
