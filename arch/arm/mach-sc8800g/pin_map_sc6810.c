...
/*
    {PIN_TD_TXPD,        ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x101    
    {PIN_TD_RXPD,        ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x101    
    {PIN_GSM_TXPD,       ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x101    
    {PIN_GSM_RXPD,       ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x101    
*/
    ...
    {PIN_SIMCLK1_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x101 NC   
    {PIN_SIMDA1_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x18A NC   
    {PIN_SIMRST1_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x101 NC
    ...
    {PIN_SD1_CLK_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN ) },    // 0x100 NC
    ...
    {PIN_KEYOUT6_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPU_EN | PIN_O_EN ) },    // 0x100  TP RESET  
    {PIN_KEYOUT7_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPU_EN | PIN_I_EN ) },    // 0x100  TP INT
    ...
    {PIN_KEYIN6_REG,     ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3   | PIN_SPD_EN | PIN_I_EN ) },    // 0x180  NC
    {PIN_KEYIN7_REG,     ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3   | PIN_SPD_EN | PIN_I_EN ) },    // 0x180  NC 
    {PIN_SPI_DI_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN ) },    // 0x18A  NC    wangfuqiang CMMB/WIFI SPI
    {PIN_SPI_CLK_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN ) },    // 0x106  NC    wangfuqiang CMMB/WIFI SPI
    {PIN_SPI_DO_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN ) },    // 0x10A  NC    wangfuqiang CMMB/WIFI SPI
    {PIN_SPI_CSN0_REG,   ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3| PIN_SPU_EN | PIN_O_EN ) },    // 0x10A  NC    wangfuqiang WIFI SPI CS
    {PIN_SPI_CSN1_REG,   ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_O_EN ) },    // 0x106  CMMB SPI CS 
    {PIN_MTDO_REG,       ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_I_EN ) },    // 0x101  JTAG  
    {PIN_MTDI_REG,       ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_I_EN ) },    // 0x18A  JTAG  
    {PIN_MTCK_REG,       ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_I_EN ) },    // 0x18A  JTAG  
    {PIN_MTMS_REG,       ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_I_EN ) },    // 0x18A  JTAG  
    ...
    {PIN_EMRST_N_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_O_EN ) },    // 0x100    EMRST(NC)
    ...
    {PIN_EMCKE1_REG,     ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_Z_EN ) },    // 0x100    
    ...
    {PIN_EMCS_N1_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x100    NC
    {PIN_EMCS_N2_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x100    NC
    {PIN_EMCS_N3_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_O_EN ) },    // 0x100    NC
    ...
    {PIN_LCD_CSN1_REG,   ( PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_2 | PIN_SPX_EN | PIN_O_EN ) }, 
    ...
    {PIN_CCIRRST_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3   | PIN_SPU_EN | PIN_Z_EN ) },    // 0x100    CAMERA RST
    {PIN_CCIRPD1_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3   | PIN_SPU_EN | PIN_Z_EN ) },    // 0x100    CAMERA PD
    {PIN_CCIRPD0_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3   | PIN_SPD_EN | PIN_Z_EN ) },    // 0x100    CAMERA PD
    ...
    {PIN_CLK_AUX0_REG,   ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN ) },    // 0x106   NC  wangfuqiang CMMB 26MHz :CLK AUX0
    ...
    {PIN_RFSEN0_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN ) },    // 0x180   QS3200 SPI LE 
    ...
    {PIN_RFCTL4_REG,     ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3   | PIN_SPX_EN | PIN_O_EN ) },    // 0x100   NC
...
/*
    {ANA_PIN_GSM_RXPD,   ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },    // 0x101    
    {ANA_PIN_GSM_TXPD,   ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },    // 0x101    
    {ANA_PIN_TD_RXPD,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },    // 0x101    
    {ANA_PIN_TD_TXPD,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },    // 0x101    
*/
    ...
    {PIN_EMRST_N_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_Z_EN ) },    // 0x100    EMRST(NC)
    ...
    {PIN_GPIO139_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    Proximity Trans pin
    {PIN_GPIO140_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    TPIC int
    {PIN_GPIO141_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_I_EN ) },    // 0x100    HP detect
    {PIN_GPIO142_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100    Proximity Recv pin
