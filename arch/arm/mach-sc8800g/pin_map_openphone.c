...
//  | Pin Register        |   DS    | Func PU/PD | Func Select  | Slp PU/PD | Sleep OE/IE | 
    ...
    {PIN_KEYOUT7_REG,    ( PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },    // 0x100  fm_32k   
    ...
    {PIN_LCD_D16_REG,    ( PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_1   | PIN_SPU_EN | PIN_Z_EN ) },    // i2c SCL
    ...
    {ANA_PIN_TP_XL_REG,  ( PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_I_EN ) },
    {ANA_PIN_TP_XR_REG,  ( PIN_DS_3 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },
    {ANA_PIN_TP_YU_REG,  ( PIN_DS_3 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN ) },
    {ANA_PIN_TP_YD_REG,  ( PIN_DS_3 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_I_EN ) },
