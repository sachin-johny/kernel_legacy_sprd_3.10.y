...
#define GEN6_MASK (	BIT_EIC2_EB | \
					BIT_IIS2_EB | \
					BIT_SPI2_EB | BIT_SPI3_EB )

#define GEN7_MASK (	BIT_I2C4_EB | \
					BIT_UART3_EB | \
					BIT_AUD_IF_EB |BIT_AUD_TOP_EB )
...
#define GR_GEN6_MASK GEN6_MASK
#define GR_GEN7_MASK GEN7_MASK

#define GR_GEN6 GR_CLK_GEN6
#define GR_GEN7 GR_CLK_GEN7
...
static void disable_apb_module(void)
{
	...
	sprd_greg_clear_bits(REG_TYPE_GLOBAL, GEN6_MASK, GR_GEN6);
	sprd_greg_clear_bits(REG_TYPE_GLOBAL, GEN7_MASK, GR_GEN7);
...
#define SAVE_GLOBAL_REG  do{ \
		...
		SAVE_GR_REG(reg_gen6_val, REG_TYPE_GLOBAL, GR_GEN6, GR_GEN6_MASK);	 \
		SAVE_GR_REG(reg_gen7_val, REG_TYPE_GLOBAL, GR_GEN7, GR_GEN7_MASK);	 \
        ...
        SAVE_GR_REG(reg_ahb_ctl6_val, REG_TYPE_AHB_GLOBAL, AHB_CTL6, AHB_CTL6_MASK);\
    }while(0)
...
#define RESTORE_GLOBAL_REG   do{  \
		...
		RESTORE_GR_REG(REG_TYPE_GLOBAL, GR_GEN6, GR_GEN6_MASK, reg_gen6_val); \
		RESTORE_GR_REG(REG_TYPE_GLOBAL, GR_GEN7, GR_GEN7_MASK, reg_gen7_val); \
        RESTORE_GR_REG(REG_TYPE_AHB_GLOBAL, AHB_CTL0, AHB_CTL0_MASK, reg_ahb_ctl0_val); \
        RESTORE_GR_REG(REG_TYPE_AHB_GLOBAL, AHB_CTL6, AHB_CTL6_MASK, reg_ahb_ctl6_val); \
    }while(0)
