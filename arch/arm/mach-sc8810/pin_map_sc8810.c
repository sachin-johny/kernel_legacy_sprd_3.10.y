...
//  | Pin Register        |   DS    | Func PU/PD | Func Select  | Slp PU/PD | Sleep OE/IE | 
	...
	{PIN_SIMCLK1_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC
	{PIN_SIMDA1_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC
	{PIN_SIMRST1_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC
	{PIN_SD0_CLK_REG, (PIN_DS_3 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x100 SD/SDIO   
	{PIN_SD_CMD_REG, (PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x180 SD/SDIO
	{PIN_SD_D0_REG, (PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x180 SD/SDIO
	{PIN_SD_D1_REG, (PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x180 SD/SDIO
	{PIN_SD_D2_REG, (PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x180 SD/SDIO
	{PIN_SD_D3_REG, (PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x180 SD/SDIO
	{PIN_SD1_CLK_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x100 SD/SDIO
	...
	{PIN_KEYOUT2_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x101 NC
	{PIN_KEYOUT3_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x101 NC
	{PIN_KEYOUT4_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x101 NC
	{PIN_KEYOUT5_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x131 NC
	{PIN_KEYOUT6_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_O_EN)},	// GPS RST
	{PIN_KEYOUT7_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_O_EN)},	// GPS PWD
	...
	{PIN_KEYIN2_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x18a   NC
	{PIN_KEYIN3_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x18a   NC
	{PIN_KEYIN4_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x18a   NC
	{PIN_KEYIN5_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_I_EN)},	// 0x1ba  PROX_INT  
	{PIN_KEYIN6_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_Z_EN)},	// 0x136  G_INT1
	{PIN_KEYIN7_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_Z_EN)},	// 0x136  G_INT2
	{PIN_SPI_DI_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x180  SPIDO  
	{PIN_SPI_CLK_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x100  SPICLK  
	{PIN_SPI_DO_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x100  SPIDI  
	{PIN_SPI_CSN0_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_O_EN)},	// 0x130  GPIO
	{PIN_SPI_CSN1_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_O_EN)},	// 0x130  GPIO
	...
	{PIN_U0RXD_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x18a  BT UART TX  
	{PIN_U0CTS_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x110  NC 
	{PIN_U0RTS_REG, (PIN_DS_1 | PIN_FPD_EN | PIN_FUNC_3 | PIN_SPU_EN | PIN_O_EN)},	// 0x110  BT RTS 
	{PIN_U1TXD_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x100  U1TXD  
	{PIN_U1RXD_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x18a  U1RXD  
	...
	{PIN_EMRST_N_REG, (PIN_DS_1 | PIN_FPD_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x100    EMRST
	...
	{PIN_EMCKE1_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x100 
	...
	{PIN_EMGPRE_LOOP_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x131   
	{PIN_EMGPST_LOOP_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x131   
	...
	{PIN_LCD_D16_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x100  NC
	{PIN_LCD_D17_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x100  NC
	{PIN_LCD_FMARK_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x100    
	...
	{PIN_CCIRRST_REG, (PIN_DS_1 | PIN_FPD_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_Z_EN)},	// 0x130 CAMERA_Reset
	{PIN_CCIRPD1_REG, (PIN_DS_1 | PIN_FPD_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x100   CAMERA will powerdown 
	{PIN_CCIRPD0_REG, (PIN_DS_1 | PIN_FPD_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x100   CAMERA will powerdown 
	...
	{PIN_CLK_AUX0_REG, (PIN_DS_3 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_O_EN)},	// 0x101   GPS_32K
	...
	{PIN_IISMCK_REG, (PIN_DS_1 | PIN_FPD_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_Z_EN)},	// 0x166    BTXTLEN = 0 
	...
	{PIN_RFCTL3_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x131   NC
	...
	{PIN_RFCTL6_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_Z_EN)},	// 0x100   NC
	{PIN_RFCTL7_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_I_EN)},	// 0x100   NC
	{PIN_RFCTL8_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x104   TD PA VMODE
	...
	{PIN_RFCTL11_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_Z_EN)},	// 0x100   NC
	{PIN_RFCTL12_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x104   PA BANDSEL1 
	{PIN_RFCTL13_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x100   NC
	{PIN_RFCTL14_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x100   NC
	{PIN_RFCTL15_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x104   
	{PIN_XTL_EN_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x131   
	{PIN_PTEST_REG, (PIN_DS_1 | PIN_FPD_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x140   
	{PIN_GPIO135_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x140   
	{PIN_GPIO136_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x140       
	{PIN_GPIO137_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_O_EN)},	// 0x140           
	{PIN_GPIO138_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_O_EN)},	// 0x140               
	{PIN_GPIO139_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_I_EN)},	// 0x140                   
	{PIN_GPIO140_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_O_EN)},	// 0x140                       
	{PIN_GPIO141_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x140                           
	{PIN_GPIO142_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x140                               
	{PIN_GPIO143_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x140                                   
	{PIN_GPIO144_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// 0x140                                       
	{PIN_SD2_CLK_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// 0x140                                           
	{PIN_SD2_CMD_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x140                                               
	{PIN_SD2_D0_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x140                                                   
	{PIN_SD2_D1_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x140                                                   
	{PIN_SD2_D2_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x140                                                   
	{PIN_SD2_D3_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	// 0x140                                                   
	...
	{PIN_SCL0_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC    
	{PIN_SDA0_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC        
	{PIN_SCL2_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC            
	{PIN_SDA2_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC            
	{PIN_SCL3_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC            
	{PIN_SDA3_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC            
	{PIN_LCD_D18_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// NC                
	{PIN_LCD_D19_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// NC                    
	{PIN_LCD_D20_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// NC                    
	{PIN_LCD_D21_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// NC                        
	{PIN_LCD_D22_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// NC                        
	{PIN_LCD_D23_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPD_EN | PIN_Z_EN)},	// NC                    
	{PIN_TRACECLK_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC                    
	...
	{PIN_SIMCLK2_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_1 | PIN_SPU_EN | PIN_Z_EN)},	// NC                                    
	{PIN_SIMDA2_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_1 | PIN_SPU_EN | PIN_Z_EN)},	// NC                                        
	{PIN_SIMRST2_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	// NC                                            
	{PIN_SIMCLK3_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_O_EN)},	// NC                                            
	{PIN_SIMDA3_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPX_EN | PIN_Z_EN)},	// NC                                                
	{PIN_SIMRST3_REG, (PIN_DS_1 | PIN_FPX_EN | PIN_FUNC_3 | PIN_SPD_EN | PIN_O_EN)},	// NC                                                    
	{ANA_PIN_TESTRSTN_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_Z_EN)},	//0x18a         TEST POINT
	{ANA_PIN_PBINT_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPU_EN | PIN_I_EN)},	//0x18a    PBINT
	{ANA_PIN_TP_XL_REG, (PIN_DS_1 | PIN_FPU_EN | PIN_FUNC_DEF | PIN_SPX_EN | PIN_Z_EN)},	//0x100      NC
