...
const unsigned long pm_func[] __initdata = {
	...
	MFP_CFG_X(U0RXD,	AF0,	DS1,	F_PULL_UP,	S_PULL_NONE,	IO_Z),	//   BT UART TX  
	MFP_CFG_X(U0CTS,	AF0,	DS1,	F_PULL_NONE,	S_PULL_NONE,	IO_Z),	//   NC 
	MFP_CFG_X(U0RTS,	AF3,	DS1,	F_PULL_NONE,	S_PULL_NONE,	IO_OE),	//   NC 
	...
	MFP_CFG_X(CCIRPD1,	AF0,	DS1,	F_PULL_DOWN,	S_PULL_NONE,	IO_Z),	//CAMERA will powerdown 
	MFP_CFG_X(CCIRPD0,	AF0,	DS1,	F_PULL_DOWN,	S_PULL_NONE,	IO_Z),	//CAMERA will powerdown 
	...
	MFP_CFG_X(RFCTL3,	AF3,	DS1,	F_PULL_NONE,	S_PULL_NONE,	IO_OE),	//  NC
	MFP_CFG_X(RFCTL4,	AF3,	DS1,	F_PULL_NONE,	S_PULL_NONE,	IO_OE),	//  NC
	...
	MFP_CFG_X(RFCTL9,	AF3,	DS1,	F_PULL_UP,	S_PULL_UP,	IO_OE),	//    NC
