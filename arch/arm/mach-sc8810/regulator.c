...
#define	LDO_PD_SET		( LDO_REG_BASE	+ 0x28 )
#define	LDO_PD_RST		( LDO_REG_BASE	+ 0x2c )
#define	LDO_PD_CTRL0		( LDO_REG_BASE	+ 0x30 )
#define	LDO_PD_CTRL1		( LDO_REG_BASE	+ 0x34 )

#define	LDO_VCTRL0		( LDO_REG_BASE	+ 0x38 )
#define	LDO_VCTRL1		( LDO_REG_BASE	+ 0x3C )
#define	LDO_VCTRL2		( LDO_REG_BASE	+ 0x40 )
#define	LDO_VCTRL3		( LDO_REG_BASE	+ 0x44 )
#define	LDO_VCTRL4		( LDO_REG_BASE	+ 0x48 )
#define	LDO_VCTRL5		( LDO_REG_BASE	+ 0x4c )

#define	LDO_SLP_CTRL0		( LDO_REG_BASE	+ 0x50 )
#define	LDO_SLP_CTRL1		( LDO_REG_BASE	+ 0x54 )
#define	LDO_SLP_CTRL2		( LDO_REG_BASE	+ 0x58 )
#define	LDO_SLP_CTRL3		( LDO_REG_BASE	+ 0x5c )
#define	LDO_DCDC_CTRL0		( LDO_REG_BASE	+ 0x100 )
#define	LDO_VARM_CTRL0		( LDO_REG_BASE	+ 0x118 )
#define	LDO_VARM_CTRL1		( LDO_REG_BASE	+ 0x11c )
#define	LDO_VARM_CTRL2		( LDO_REG_BASE	+ 0x120 )

#define	LDO_PD_SET_MSK		( 0x3FFF	)
...
static struct sc8810_regulator sc8810_regulator_regs[] = {
#ifdef CONFIG_ARCH_SC7710
	SC8810_REGU(	LDO_VDDARM,     LDO_PD_SET,     BIT(11), LDO_PD_RST,    BIT(11),LDO_VARM_CTRL0,BIT(0),LDO_SLP_CTRL1,BIT(4)	),
	...
	SC8810_REGU(	LDO_VDDCORE,    LDO_PD_SET,     BIT(1), LDO_PD_RST,     BIT(1), LDO_DCDC_CTRL0,	BIT(0), LDO_NA, 	LDO_NA	),
	SC8810_REGU(	LDO_LDO_BG,     LDO_PD_SET,     BIT(0), LDO_PD_RST,     BIT(0), LDO_DCDC_CTRL0,	BIT(0), LDO_NA, 	LDO_NA	),
	SC8810_REGU(	LDO_AVDDVB,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA, 	LDO_NA	),
	...
	SC8810_REGU(	LDO_VDDSIM3,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_VDDSIM2,    LDO_PD_CTRL0,   BIT(14),LDO_PD_CTRL0,   BIT(15),LDO_VCTRL1, BIT(8), LDO_SLP_CTRL0,	BIT(8)	),
	SC8810_REGU(	LDO_VDDWIF1,    LDO_PD_CTRL1,   BIT(2), LDO_PD_CTRL1,   BIT(3), LDO_VCTRL4, BIT(0), LDO_SLP_CTRL1,	BIT(5)	),
	SC8810_REGU(	LDO_VDDWIF0,    LDO_PD_CTRL1,   BIT(0), LDO_PD_CTRL1,   BIT(1), LDO_VCTRL3, BIT(12),LDO_SLP_CTRL1,	BIT(4)	),
//TBD	SC8810_REGU(	LDO_VDDEMMIO,   LDO_PD_CTRL1,   BIT(2), LDO_PD_CTRL1,   BIT(3), LDO_VCTRL4, BIT(12),LDO_SLP_CTRL1,	BIT(7)	),
//TBD	SC8810_REGU(	LDO_VDDEMMCORE, LDO_PD_CTRL1,   BIT(2), LDO_PD_CTRL1,   BIT(3), LDO_VCTRL4, BIT(8), LDO_SLP_CTRL1,	BIT(6)	),
	SC8810_REGU(	LDO_VDDSD1,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_VDDRTC, LDO_NA, 	LDO_NA, LDO_NA, 	LDO_NA, LDO_VCTRL0, BIT(0), LDO_NA, 	LDO_NA	),
	SC8810_REGU(	LDO_DVDD18,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_LDO_PA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,	LDO_NA,		LDO_NA	),
...
static int __devinit sc8810_regulator_probe(struct platform_device *pdev)
{
    ...
    printk("sc8810_regulator_probe:%x %d, %x \n", pdev, pdev->id, pdev->dev.platform_data);
