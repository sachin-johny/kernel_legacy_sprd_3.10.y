...
static struct sc8810_regulator sc8810_regulator_regs[] = {
	SC8810_REGU(	LDO_VDDARM,	LDO_PD_SET,	BIT_9,	LDO_PD_RST,	BIT_9,	LDO_VARM_CTRL,	BIT_0,	LDO_SLP_CTRL1,	BIT_4	),
	SC8810_REGU(	LDO_VDD25,	LDO_PD_SET,	BIT_8,	LDO_PD_RST,	BIT_8,	LDO_VCTRL3,	BIT_8,	LDO_SLP_CTRL0,	BIT_13	),
	SC8810_REGU(	LDO_VDD18,	LDO_PD_SET,	BIT_7,	LDO_PD_RST,	BIT_7,	LDO_VCTRL3,	BIT_4,	LDO_SLP_CTRL0,	BIT_12	),
	SC8810_REGU(	LDO_VDD28,	LDO_PD_SET,	BIT_6,	LDO_PD_RST,	BIT_6,	LDO_VCTRL3,	BIT_0,	LDO_SLP_CTRL0,	BIT_11	),
	SC8810_REGU(	LDO_AVDDBB,	LDO_PD_SET,	BIT_5,	LDO_PD_RST,	BIT_5,	LDO_VCTRL0,	BIT_12,	LDO_SLP_CTRL0,	BIT_10	),
	SC8810_REGU(	LDO_VDDRF0,	LDO_PD_SET,	BIT_3,	LDO_PD_RST,	BIT_3,	LDO_VCTRL0,	BIT_4,	LDO_SLP_CTRL0,	BIT_0	),
	SC8810_REGU(	LDO_VDDRF1,	LDO_PD_SET,	BIT_4,	LDO_PD_RST,	BIT_4,	LDO_VCTRL0,	BIT_8,	LDO_SLP_CTRL0,	BIT_1	),
	SC8810_REGU(	LDO_VDDMEM,	LDO_PD_SET,	BIT_2,	LDO_PD_RST,	BIT_2,	LDO_NA,		LDO_NA,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_VDDCORE,	LDO_PD_SET,	BIT_1,	LDO_PD_RST,	BIT_1,	LDO_DCDC_CTRL,	BIT_0,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_LDO_BG,	LDO_PD_SET,	BIT_0,	LDO_PD_RST,	BIT_0,	LDO_DCDC_CTRL,	BIT_0,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_AVDDVB,	LDO_PD_CTRL0,	BIT_14,	LDO_PD_CTRL0,	BIT_15,	LDO_VCTRL1,	BIT_8,	LDO_SLP_CTRL0,	BIT_8	),
	SC8810_REGU(	LDO_VDDCAMDA,	LDO_PD_CTRL0,	BIT_12,	LDO_PD_CTRL0,	BIT_13,	LDO_VCTRL2,	BIT_8,	LDO_SLP_CTRL0,	BIT_7	),
	SC8810_REGU(	LDO_VDDCAMD1,	LDO_PD_CTRL0,	BIT_10,	LDO_PD_CTRL0,	BIT_11,	LDO_VCTRL2,	BIT_4,	LDO_SLP_CTRL0,	BIT_6	),
	SC8810_REGU(	LDO_VDDCAMD0,	LDO_PD_CTRL0,	BIT_8,	LDO_PD_CTRL0,	BIT_9,	LDO_VCTRL2,	BIT_0,	LDO_SLP_CTRL0,	BIT_5	),
	SC8810_REGU(	LDO_VDDSIM1,	LDO_PD_CTRL0,	BIT_6,	LDO_PD_CTRL0,	BIT_7,	LDO_VCTRL1,	BIT_4,	LDO_SLP_CTRL0,	BIT_3	),
	...
	SC8810_REGU(	LDO_VDDWIF0,	LDO_PD_CTRL1,	BIT_2,	LDO_PD_CTRL1,	BIT_3,	LDO_VCTRL4,	BIT_0,	LDO_SLP_CTRL1,	BIT_0	),
	SC8810_REGU(	LDO_VDDSD1,	LDO_PD_CTRL1,	BIT_0,	LDO_PD_CTRL1,	BIT_1,	LDO_VCTRL3,	BIT_12,	LDO_SLP_CTRL0,	BIT_15	),
	SC8810_REGU(	LDO_VDDRTC,	LDO_NA,		LDO_NA,	LDO_NA,		LDO_NA,	LDO_VCTRL0,	BIT_0,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_DVDD18,	LDO_PD_SET,	BIT_1,	LDO_PD_RST,	BIT_1,	LDO_DCDC_CTRL,	BIT_0,	LDO_NA,		LDO_NA	),
	SC8810_REGU(	LDO_LDO_PA,	LDO_PA_CTRL1,	BIT_9,	LDO_PA_CTRL1,	BIT_8,	LDO_PA_CTRL1,	BIT_4,	LDO_NA,		LDO_NA	),
};
...
static int sc8810_regulator_get_voltage_sel(struct regulator_dev *rdev)
{
	...
	if(unlikely(reg->reg_level_addr > LDO_VCTRL4)) {
		...
		val = LDO_REG_GET(reg->reg_level_addr);
		sel = (((val & (reg->reg_level_start_bit))?(BIT_0):0) |
			((val & ((reg->reg_level_start_bit)<<1))?(BIT_1):0) |
			((val & ((reg->reg_level_start_bit)<<2))?(BIT_2):0));
	}
	else {
		val = LDO_REG_GET(reg->reg_level_addr);
		sel = (((val & (reg->reg_level_start_bit))?(BIT_0):0) |
			((val & ((reg->reg_level_start_bit)<<2))?(BIT_1):0));
	}
	return sel;
}
