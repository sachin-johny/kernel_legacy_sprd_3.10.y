...
#ifdef CONFIG_MACH_SP7710GA_ORANGE
#include <mach/gpio-sp7710ga_orange.h>
#endif
...
//#define SPRD_ION_SIZE           (CONFIG_SPRD_ION_SIZE*SZ_1M)
    ...
    #define SPRD_ION_SIZE   (16*1024*1024)
...
#ifdef CONFIG_SPRD_PHYSICAL_MEMORY_SIZE
#define SPRD_PHYSICAL_MEMORY_SIZE CONFIG_SPRD_PHYSICAL_MEMORY_SIZE
#else
#define SPRD_PHYSICAL_MEMORY_SIZE 256
#endif
...
#define SPRD_PMEM_BASE		((SPRD_PHYSICAL_MEMORY_SIZE*SZ_1M)-SPRD_IO_MEM_SIZE)
