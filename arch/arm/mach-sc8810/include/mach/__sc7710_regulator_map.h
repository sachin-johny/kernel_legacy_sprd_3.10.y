 ...
 */
	...
	1100, ANA_REG_GLB_DCDC_CORE_CTRL0, BIT(0)|BIT(1)|BIT(2), 8, 1100, 700, 800, 900, 1000, 650, 1200, 1300);
	...
	1200, ANA_REG_GLB_DCDC_ARM_CTRL0, BIT(0)|BIT(1)|BIT(2), 8, 1100, 700, 800, 900, 1000, 650, 1200, 1300);
	...
	0, ANA_REG_GLB_DCDC_MEM_CTRL0, BIT(0)|BIT(1)|BIT(2), 8, 1200, 1250, 1350, 1300, 1500, 1400, 1800, 1900);
	...
	ANA_REG_GLB_LDO_TRIM6, BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12), ANA_REG_GLB_LDO_CAL, BIT(6)|BIT(7)|BIT(18)|BIT(20),
	...
	2800, ANA_REG_GLB_LDO_VCTRL3, BIT(12)|BIT(13)|BIT(14)|BIT(15), 4, 3300, 2800, 1800, 1200);
	...
	2800, ANA_REG_GLB_LDO_VCTRL4, BIT(0)|BIT(1)|BIT(2)|BIT(3), 4, 3300, 2800, 1800, 1200);
	...
	0, ANA_REG_GLB_LDO_VCTRL4, BIT(4)|BIT(5)|BIT(6)|BIT(7), 4, 1800, 2800, 2500, 2600);
