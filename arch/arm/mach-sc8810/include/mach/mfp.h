...
#define PIN_SIMCLK2_REG_OFFS                          (0x0464)
#define PIN_SIMDA2_REG_OFFS                           (0x0468)
#define PIN_SIMRST2_REG_OFFS                          (0x046C)
#define PIN_SIMCLK3_REG_OFFS                          (0x0470)
#define PIN_SIMDA3_REG_OFFS                           (0x0474)
#define PIN_SIMRST3_REG_OFFS                          (0x0478)
