...
#define REGU_NAMES_VDDWIF1      REGULATOR_SUPPLY(REGU_NAME_TP,          NULL),
#define REGU_NAMES_VDDSD0       REGULATOR_SUPPLY(REGU_NAME_SDHOST0,     NULL),
#define REGU_NAMES_VDDSIM2      REGULATOR_SUPPLY(REGU_NAME_SDHOST1,             NULL),
#define REGU_NAMES_VDDRF1       REGULATOR_SUPPLY(REGU_NAME_TP1,         NULL),
...
#define REGU_NAMES_VDD18        REGULATOR_SUPPLY(REGU_NAME_LCDIO,       NULL),
#define REGU_NAMES_VDDWIF0      REGULATOR_SUPPLY(REGU_NAME_MIC,         NULL),

#define REGU_INIT_VDDWIF0	\
	REGU_INIT_STATUS(LDO_VDDWIF0,		LDO_INIT_ON,	LDO_INIT_NA,	LDO_INIT_SLP_ON)
