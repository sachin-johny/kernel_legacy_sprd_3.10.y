...
#define	NK_OSCTX_DATE		 0x171010 /* file modification date: DDMMYY */
...
struct NkOsCtx {
    ...
    nku32_f	 pad_vars[24];	/* space for future variables storage */
    ...
    nku32_f	 pad_ops[3];	/* space for future ops storage */
