...
{
/* wait for timer load is not busy*/
...
#define SC_MULT		2581110154u  //26MHz
#define SC_SHIFT	26           //26MHz
 */
/* 76.8MHz */
#define SC_MULT		1747626667u
#define SC_SHIFT	27
...
void sc8825_enable_timer_early(void)
{
	...
	sci_glb_set(REG_GLB_GEN0,
		    ...
		    BIT_SYST0_EB);
	__sched_clock_init(__get_apb_clk());
}
...
void __init sc8825_timer_init(void)
{
	...
	__gptimer_clocksource_init("gptimer2", __get_apb_clk());
