...
static const int LDO_VDDSD3_voltage_table[] = {
	1500000,
	1800000,
	1300000,
	1200000,
};
static const int LDO_VDD3V_voltage_table[] = {
	2800000,
	3000000,
	2500000,
	1800000,
...
static struct sc8810_regulator sc8810_regulator_regs[] = {
	...
	SC8810_REGU(	LDO_VDDSD3,	LDO_PD_CTRL1,	BIT(4),	LDO_PD_CTRL1,	BIT(5),	LDO_VCTRL4,	BIT(4),	LDO_SLP_CTRL0,	BIT(15)	),
	SC8810_REGU(	LDO_VDD3V,	LDO_PD_CTRL1,	BIT(6),	LDO_PD_CTRL1,	BIT(7),	LDO_VCTRL4,	BIT(8),	LDO_SLP_CTRL0,	BIT(1)	),
