...
#define REGU_NAMES_VDDSIM3	REGULATOR_SUPPLY(REGU_NAME_CMMB,	NULL),
#define REGU_NAMES_VDDRF1	REGULATOR_SUPPLY(REGU_NAME_CMMBIO,	NULL),
#define REGU_NAMES_VDDWIF0	REGULATOR_SUPPLY(REGU_NAME_GPS,		NULL),
...
#define REGU_NAMES_VDDSD3	REGULATOR_SUPPLY(REGU_NAME_SDHOST3,	NULL),
#define REGU_NAMES_VDD3V	REGULATOR_SUPPLY(REGU_NAME_VDD3V,	NULL),
