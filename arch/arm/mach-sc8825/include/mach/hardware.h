...
#define SPRD_AHB_BASE		SCI_IOMAP(0x224000)
...
#define SPRD_ISP_BASE		SCI_IOMAP(0x250000)
...
#define SPRD_RTC_BASE		SCI_IOMAP(0x258000)
...
#define SPRD_MIPI_DSIC_SIZE		SZ_8K
#define SPRD_MIPI_CSI2_BASE		(SPRD_MIPI_DSIC_BASE + SZ_4K)
