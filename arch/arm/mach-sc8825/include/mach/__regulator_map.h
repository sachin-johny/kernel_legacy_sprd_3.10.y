 ...
 */
    ...
    SCI_REGU_REG(avddao, 0, 0, 0, 0, 0, ANA_REG_GLB_LDO_SLP_CTRL1, BIT(10),
	0, 0, 8, 2900, 3100, 3200, 3300, 3400, 3500, 3600, 3800);

    SCI_REGU_REG(avddvb, 0, 0, 0, 0, 0, ANA_REG_GLB_LDO_SLP_CTRL1, BIT(9),
	0, 0, 8, 2900, 3100, 3200, 3300, 3400, 3500, 3600, 3800);
    ...
    SCI_REGU_REG(micbias, 0, 0, 0, 0, 0, ANA_REG_GLB_LDO_SLP_CTRL1, BIT(11),
	0, 0, 4, 1900, 2100, 2300, 2500);

    SCI_REGU_REG(auxmicbias, 0, 0, 0, 0, 0, ANA_REG_GLB_LDO_SLP_CTRL1, BIT(12),
	0, 0, 4, 1900, 2100, 2300, 2500);
