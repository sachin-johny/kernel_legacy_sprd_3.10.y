 ...
 */
	...
	ANA_REG_GLB_LDO_VCTRL3, BIT(8)|BIT(9)|BIT(10)|BIT(11), 4, 2500, 2750, 3000, 2900);
	...
	ANA_REG_GLB_LDO_VCTRL0, BIT(12)|BIT(13)|BIT(14)|BIT(15), 4, 3000, 3100, 2900, 2800);

    SCI_REGU_REG(avddao, 0, 0, 0, 0, 0, 0, 0,
	0, 0, 8, 2900, 3100, 3200, 3300, 3400, 3500, 3600, 3800);

    SCI_REGU_REG(avddvb, 0, 0, 0, 0, 0, 0, 0,
	0, 0, 8, 2900, 3100, 3200, 3300, 3400, 3500, 3600, 3800);

    SCI_REGU_REG(vddrtc, 0, 0, 0, 0, 0, 0, 0,
	ANA_REG_GLB_LDO_VCTRL0, BIT(0)|BIT(1)|BIT(2)|BIT(3), 4, 1800, 1700, 1600, 1500);

    SCI_REGU_REG(vbatbk, 0, 0, 0, 0, 0, 0, 0,
	0, 0, 4, 2600, 3000, 2800, 3100);

    SCI_REGU_REG(micbias, 0, 0, 0, 0, 0, 0, 0,
	0, 0, 4, 1900, 2100, 2300, 2500);

    SCI_REGU_REG(auxmicbias, 0, 0, 0, 0, 0, 0, 0,
	0, 0, 4, 1900, 2100, 2300, 2500);
