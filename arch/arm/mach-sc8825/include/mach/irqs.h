...
/*
 * tiger A5MPCore interrupt sources (primary GIC on the core)
 */
#ifdef CONFIG_SMP 
#undef  IRQ_SER0_INT
#define IRQ_SER0_INT			(IRQ_GIC_START + 2)
#undef  IRQ_SER1_INT			
#define IRQ_SER1_INT			(IRQ_GIC_START + 3)
#undef  IRQ_SER2_INT			
#define IRQ_SER2_INT			(IRQ_GIC_START + 4)
#undef  IRQ_SER3_INT			
#define IRQ_SER3_INT			(IRQ_GIC_START + 5)
#else
#define IRQ_SER0_INT		2
#define IRQ_SER1_INT		3
#define IRQ_SER2_INT		4
...
#define IRQ_TIMER0			(IRQ_GIC_START + 6)
#ifdef CONFIG_SMP
#define IRQ_TIMER1			(IRQ_GIC_START + 7)
#else
#define IRQ_TIMER1			(6)
#endif
#define IRQ_TIMER2			(IRQ_GIC_START + 8)
#define IRQ_SYSTIMER0		(IRQ_GIC_START + 9)
#define IRQ_GPIO			(IRQ_GIC_START + 10)		/* main GIC */
#define IRQ_SPI0			(IRQ_GIC_START + 11)		/* tile GIC */
#define IRQ_SPI1			(IRQ_GIC_START + 12)		/* main GIC */
#define IRQ_SPI2			(IRQ_GIC_START + 13)		/* tile GIC */
#define IRQ_KPD				(IRQ_GIC_START + 14)
#define IRQ_SIM0			(IRQ_GIC_START + 15)
#define IRQ_SIM1			(IRQ_GIC_START + 16)
#define IRQ_I2C0			(IRQ_GIC_START + 17)
#define IRQ_I2C1			(IRQ_GIC_START + 18)
#define IRQ_I2C2			(IRQ_GIC_START + 19)
#define IRQ_I2C3			(IRQ_GIC_START + 20)
#define IRQ_EIC				(IRQ_GIC_START + 21)
