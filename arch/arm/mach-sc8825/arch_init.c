...
#define AUX_VALUE (CACHE_EARLY_BRESP_ENABLE | CACHE_I_P_ENABLE | \
		CACHE_D_P_ENABLE |CACHE_N_S_ACCESS | CACHE_N_L_ENABLE | \
		CACHE_REPLACE_POLICY | CACHE_FORCE_W_A | CACHE_S_O_ENABLE | \
		CACHE_PARITY_ENABLE | CACHE_EVENT_ENABLE | CACHE_WAY_SIZE | \
		CACHE_ASSOCI | CACHE_SHARED_INV_ENABLE | CACHE_EC_CONFIG | \
		CACHE_STORE_BUFFER_LIMI_ENABLE | CACHE_HIGH_PRIORITY_SO_DEV | \
		CACHE_FULL_LINE_ZERO_ENABLE)
