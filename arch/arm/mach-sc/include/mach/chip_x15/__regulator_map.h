 ...
 */
    ...
    SCI_REGU_REG(dcdcmem, 2, ANA_REG_GLB_LDO_DCDC_PD, BIT(11), 0, 0, 0, 0,
    ...
    SCI_REGU_REG(dcdcgen, 2, ANA_REG_GLB_LDO_DCDC_PD, BIT(12), 0, 0, ANA_REG_GLB_PWR_SLP_CTRL0, BIT(10),
    ...
    SCI_REGU_REG(dcdcwpa, 2, ANA_REG_GLB_LDO_PD_CTRL, BIT(10), 0, 0, ANA_REG_GLB_PWR_SLP_CTRL0, BIT(9),
