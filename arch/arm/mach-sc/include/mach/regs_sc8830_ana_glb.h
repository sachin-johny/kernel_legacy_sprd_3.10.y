...
#define ANA_REG_GLB_ARCH_EN             SCI_ADDR(ANA_REGS_GLB_BASE, 0x0128)
...
#define BIT_LDO_AVDD18_PD               ( BIT(0) )
...
#define BITS_VIBR_V_CONVERT_CNT_HW(_x_) ( (_x_) << 0 )
...
#define BITS_DCDC_WRF_CAL_ADI(_x_)      ( (_x_) << 0 & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)) )
