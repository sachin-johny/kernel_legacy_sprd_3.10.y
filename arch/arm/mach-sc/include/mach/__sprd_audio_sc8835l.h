...
#ifndef __ASM_ARCH_AUDIO_GLB_SCX35L_H
#define __ASM_ARCH_AUDIO_GLB_SCX35L_H
...
static inline int arch_audio_vbc_switch(int master)
{
	...
	int mask =
		...
		sci_glb_set(REG_AON_APB_CP0_WPROT_EN0, BIT(6));
		sci_glb_set(REG_AON_APB_CP1_WPROT_EN0, BIT(6));
	...
	case AUDIO_TO_AP_ARM_CTRL:
		...
		sci_glb_clr(REG_AON_APB_AP_WPROT_EN0, BIT(6));
	...
	case AUDIO_TO_CP0_DSP_CTRL:
		...
		sci_glb_clr(REG_AON_APB_CP0_WPROT_EN0, BIT(6));
		val =
	...
	case AUDIO_TO_CP1_DSP_CTRL:
		arch_audio_vbc_reset();
		arch_audio_vbc_reg_enable();
		sci_glb_clr(REG_AON_APB_CP1_WPROT_EN0, BIT(6));
		val =
