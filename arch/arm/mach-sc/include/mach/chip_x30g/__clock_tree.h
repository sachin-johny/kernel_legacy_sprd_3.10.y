...
SCI_CLK_ADD(clk_mpll, 0, REG_PMU_APB_CGM_AP_EN, BIT(6),
	REG_AON_APB_MPLL_CFG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10), 0, 0,
	1, &ext_26m);

SCI_CLK_ADD(clk_dpll, 0, REG_PMU_APB_CGM_AP_EN, BIT(1),
	REG_AON_APB_DPLL_CFG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10), 0, 0,
	1, &ext_26m);
...
SCI_CLK_ADD(clk_tdpll, 0, REG_PMU_APB_CGM_AP_EN, BIT(3),
	REG_AON_APB_TDPLL_CFG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10), 0, 0,
	1, &ext_26m);

SCI_CLK_ADD(clk_wpll, 0, REG_PMU_APB_CGM_AP_EN, BIT(5),
	REG_AON_APB_WPLL_CFG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10), 0, 0,
	1, &clk_w_sel_i);

SCI_CLK_ADD(clk_cpll, 0, REG_PMU_APB_CGM_AP_EN, BIT(2),
	REG_AON_APB_CPLL_CFG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10), 0, 0,
	1, &clk_c_sel_i);

SCI_CLK_ADD(clk_wifipll, 0, REG_PMU_APB_CGM_AP_EN, BIT(4),
	REG_AON_APB_WIFIPLL1_CFG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10), 0, 0,
	1, &clk_wifi_sel_i);

SCI_CLK_ADD(clk_460m8, 0, REG_PMU_APB_PLL_DIV_EN1, BIT(20),
	2, 0, 0, 0,
	1, &clk_wpll);
...
SCI_CLK_ADD(clk_66m, 0, REG_PMU_APB_PLL_DIV_EN1, BIT(2),
	16, 0, 0, 0,
	1, &clk_dpll);

SCI_CLK_ADD(clk_51m2_w, 0, REG_PMU_APB_PLL_DIV_EN1, BIT(23),
	18, 0, 0, 0,
	1, &clk_wpll);

SCI_CLK_ADD(clk_40m, 0, REG_PMU_APB_PLL_DIV_EN1, BIT(27),
	22, 0, 0, 0,
	1, &clk_wifipll);
...
SCI_CLK_ADD(clk_emc, 0, 0, 0,
	...
	4, &ext_26m, &clk_256m, &clk_384m, &clk_dpll);
...
/*
SCI_CLK_ADD(clk_zipdec_emc, 0, REG_AP_AHB_AHB_EB, BIT(21),
	0, 0, REG_AP_CLK_ZIPENC_CFG, BIT(0)|BIT(1),
	4, &clk_96m, &clk_153m6, &clk_192m, &clk_256m);

SCI_CLK_ADD(clk_zipenc_emc, 0, REG_AP_AHB_AHB_EB, BIT(20),
	0, 0, REG_AP_CLK_ZIPENC_CFG, BIT(0)|BIT(1),
	4, &clk_96m, &clk_153m6, &clk_192m, &clk_256m);

SCI_CLK_ADD(clk_nandc_ecc, 0, REG_AP_AHB_AHB_EB, BIT(19),
	0, 0, REG_AP_CLK_NANDC_ECC_CFG, BIT(0),
...
SCI_CLK_ADD(clk_sdio0, 0, REG_AP_AHB_AHB_EB, BIT(8),
	...
	4, &ext_26m, &clk_256m, &clk_312m, &clk_384m);
...
SCI_CLK_ADD(clk_gpu, 0, &clk_gpu_i, 0,
	REG_GPU_APB_APB_CLK_CTRL, BIT(4)|BIT(5), REG_GPU_APB_APB_CLK_CTRL, BIT(0)|BIT(1)|BIT(2),
	7, &clk_153m6, &clk_208m, &clk_256m, &clk_300m, &clk_312m, &clk_384m, &clk_460m8);
...
SCI_CLK_ADD(clk_mmu, 0, REG_MM_AHB_AHB_EB, BIT(7),
	0, 0, 0, 0,
	1, &clk_mm_ahb);
...
SCI_CLK_ADD(clk_adi, 0, REG_AON_APB_APB_EB0, BIT(16),
	...
	4, &ext_26m, &clk_38m4, &clk_51m2, &clk_64m);
...
SCI_CLK_ADD(clk_ca7_dap, 0, REG_AON_APB_APB_EB0, BIT(30),
	0, 0, REG_AON_CLK_CA7_DAP_CFG, BIT(0)|BIT(1),
	4, &ext_26m, &clk_76m8, &clk_128m, &clk_153m6);

SCI_CLK_ADD(clk_ca7_ts, 0, REG_AON_APB_APB_EB0, BIT(28),
