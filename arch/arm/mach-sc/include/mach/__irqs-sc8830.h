...
#define IRQ_TIMER0_INT			SCI_IRQ(28)
#define IRQ_TIMER1_INT			SCI_IRQ(29)
#define IRQ_SYSTIME_INT			SCI_IRQ(30)
#define IRQ_SYSTIME1_INT			SCI_IRQ(31)
...
#define IRQ_CA7COMTX0_INT			SCI_IRQ(98)
#define IRQ_CA7COMTX1_INT			SCI_IRQ(99)
#define IRQ_CA7COMTX2_INT			SCI_IRQ(100)
#define IRQ_CA7COMTX3_INT			SCI_IRQ(101)
#define IRQ_CA7COMRX0_INT			SCI_IRQ(102)
#define IRQ_CA7COMRX1_INT			SCI_IRQ(103)
#define IRQ_CA7COMRX2_INT			SCI_IRQ(104)
#define IRQ_CA7COMRX3_INT			SCI_IRQ(105)
#define IRQ_NCNTV0_INT			SCI_IRQ(106)
#define IRQ_NCNTV1_INT			SCI_IRQ(107)
#define IRQ_NCNTV2_INT			SCI_IRQ(108)
#define IRQ_NCNTV3		SCI_IRQ(109)
#define IRQ_NCNTHP0_INT			SCI_IRQ(110)
#define IRQ_NCNTHP1_INT			SCI_IRQ(111)
#define IRQ_NCNTHP2_INT			SCI_IRQ(112)
#define IRQ_NCNTHP3_INT			SCI_IRQ(113)
#define IRQ_NCNTPN0_INT			SCI_IRQ(114)
#define IRQ_NCNTPN1_INT			SCI_IRQ(115)
#define IRQ_NCNTPN2_INT			SCI_IRQ(116)
#define IRQ_NCNTPN3_INT			SCI_IRQ(117)
#define IRQ_NCNTPS0_INT			SCI_IRQ(118)
#define IRQ_NCNTPS1_INT			SCI_IRQ(119)
