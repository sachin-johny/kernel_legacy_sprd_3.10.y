...
#define SPRD_NFC_BASE			SCI_IOMAP(0x12a000)
#define SPRD_NFC_PHYS			0X20C00000
#define SPRD_NFC_SIZE			SZ_4K

#define SPRD_HWLOCK0_BASE		SCI_IOMAP(0x12c000)
...
#define SPRD_AXIBM9_BASE		SCI_IOMAP(0x500000)
#define SPRD_AXIBM9_PHYS		0X300D0000
#define SPRD_AXIBM9_SIZE		(SZ_4K)

#define SPRD_AUDIO_BASE			SCI_IOMAP(0x1b0000)
#define SPRD_AUDIO_PHYS			0X40000000
#define SPRD_AUDIO_SIZE			SZ_8K

#define SPRD_AUDIO_IF_BASE		SCI_IOMAP(0x1b3000)
#define SPRD_AUDIO_IF_PHYS		0X40010000
#define SPRD_AUDIO_IF_SIZE		SZ_4K

#define SPRD_VBC_BASE			SCI_IOMAP(0x1b5000)
#define SPRD_VBC_PHYS			0X40020000
#define SPRD_VBC_SIZE			SZ_4K + SZ_8K

#define SPRD_ADI_BASE			SCI_IOMAP(0x1c0000)
#define SPRD_ADI_PHYS			0X40030000
#define SPRD_ADI_SIZE			(SZ_4K)

#define SPRD_ADISLAVE_BASE		SCI_IOMAP(0x1c0000 + SZ_32K)
#define SPRD_ADISLAVE_PHYS		0X40038000
#define SPRD_ADISLAVE_SIZE		(SZ_4K)

#define SPRD_SYSTIMER_CMP_BASE		SCI_IOMAP(0x1d0000)
#define SPRD_SYSTIMER_CMP_PHYS		0X40040000
#define SPRD_SYSTIMER_CMP_SIZE		SZ_4K

#define SPRD_GPTIMER0_BASE		SCI_IOMAP(0x1d2000)
#define SPRD_GPTIMER0_PHYS		0X40050000
#define SPRD_GPTIMER0_SIZE		SZ_4K

#define SPRD_HWLOCK1_BASE		SCI_IOMAP(0x1d4000)
#define SPRD_HWLOCK1_PHYS		0X40060000
#define SPRD_HWLOCK1_SIZE		SZ_4K

#define SPRD_MDAR_BASE			SCI_IOMAP(0x1d6000)
#define SPRD_MDAR_PHYS			0X40070000
#define SPRD_MDAR_SIZE			SZ_4K

#define SPRD_I2C_BASE			SCI_IOMAP(0x1f8000)
#define SPRD_I2C_PHYS			0X40080000
#define SPRD_I2C_SIZE			SZ_4K

#define SPRD_SEND_MBOX_BASE			SCI_IOMAP(0x1fa000)
#define SPRD_SEND_MBOX_PHYS			0X400a0000
#define SPRD_SEND_MBOX_SIZE			SZ_4K

#define SPRD_RECV_MBOX_BASE			SCI_IOMAP(0x1fc000)
#define SPRD_RECV_MBOX_PHYS			0X400a8000
#define SPRD_RECV_MBOX_SIZE			SZ_4K

#define SPRD_INT_BASE			SCI_IOMAP(0x1fe000)
...
#define SPRD_AON_DMA0_BASE		SCI_IOMAP(0x2b1000)
#define SPRD_AON_DMA0_PHYS		0x40100000
#define SPRD_AON_DMA0_SIZE		SZ_16K
...
#define SPRD_IRAM1_SIZE                        (SZ_8K )

#define SPRD_AON_RAM_BASE              SCI_IOMAP(0x420000)
#define SPRD_AON_RAM_PHYS              0x50002000 /*0x50800000+32k-4k*/
#define SPRD_AON_RAM_SIZE              (SZ_64K-SZ_16K)
#define PMIC_SIPC_RING_ADDR            (SPRD_AON_RAM_BASE+SZ_32K+SZ_4K)
#define PMIC_SIPC_RING_SIZE            (SZ_8K)
