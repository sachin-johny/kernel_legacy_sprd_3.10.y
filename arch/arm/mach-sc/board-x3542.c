...
#include <mach/i2s.h>
#ifdef CONFIG_TOUCHSCREEN_MSG2133A
...
#endif
#ifdef CONFIG_TOUCHSCREEN_MSG2133A
static struct msg2133a_ts_platform_data msg2133a_ts_info = {
	.irq_gpio_number	= GPIO_TOUCH_IRQ,
	.reset_gpio_number	= GPIO_TOUCH_RESET,
	.vdd_name 			= "vdd28",
};
...
static struct i2c_board_info i2c1_boardinfo[] = {
#ifdef CONFIG_TOUCHSCREEN_MSG2133A
     	{
	        ...
	        .platform_data = &msg2133a_ts_info,
	},
#endif
#ifdef CONFIG_TOUCHSCREEN_FT5306
	{
...
#ifdef CONFIG_INPUT_MXC622X_I2C
	 { 
		I2C_BOARD_INFO(MXC622X_ACC_DEV_NAME, MXC622X_ACC_I2C_ADDR),
