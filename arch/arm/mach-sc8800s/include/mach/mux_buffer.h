...
extern void mux_ringbuffer_init(struct mux_ringbuffer *rbuf, void *data, size_t len);
 ...
 */
extern ssize_t mux_ringbuffer_pkt_next(struct mux_ringbuffer *rbuf, size_t idx, size_t* pktlen);
