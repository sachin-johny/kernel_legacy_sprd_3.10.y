/* linux/arch/arm/mach-sc8800s/board-bigphone.c
 *
...
static void __init bigphone_init_irq(void)
{
	sprd_init_irq();
}
...
static void __init
bigphone_fixup(struct machine_desc *desc, struct tag *tag,
...
MACHINE_START(BIGPHONE, "SPRDBP")
/* UART for LL DEBUG */
	.phys_io        = SPRD_SERIAL1_PHYS,
	.io_pg_offst    = ((SPRD_SERIAL1_BASE) >> 18) & 0xfffc,

	.map_io         = bigphone_map_io,
	.init_irq       = bigphone_init_irq,
	.init_machine   = bigphone_init,
	.timer          = &sprd_timer,
	.fixup          = bigphone_fixup,
MACHINE_END
