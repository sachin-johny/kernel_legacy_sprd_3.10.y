/*
* drivers/media/video/sprd_dcam/sc8810/dcam_drv_sc8810.h
...
int32_t ISP_DriverNoticeRegister (uint32_t base_addr,ISP_IRQ_NOTICE_ID_E notice_id,ISP_ISR_FUNC_PTR user_func);
