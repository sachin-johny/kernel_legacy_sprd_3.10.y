...
{
    //SCI_ASSERT(image_format <= SENSOR_IMAGE_FORMAT_MAX);
    ...
    SENSOR_TRACE("Sensor_SelectSensorFormat: image_format %d, s_sensor_image_format = %d", image_format, s_sensor_image_format);
}
