...
/*lint -save -e533 */
//__align(4)  SENSOR_REG_T ov2655_YUV_COMMON[]=
...
//7.5fps
//__align(4) SENSOR_REG_T ov2655_YUV_1600X1200[]=
...
//__align(4) SENSOR_REG_T ov2655_YUV_1280X960[]=
...
//18MHz@24MHz MCLK
//15fps
//__align(4) SENSOR_REG_T ov2655_YUV_640X480[]=
...
//__align(4) const SENSOR_REG_T ov2655_yuv422_mode[]=
...
//__align(4) const SENSOR_REG_T ov2655_awb_tab[][5]=
...
//		
/******************************************************************************/
//__align(4) const SENSOR_REG_T ov2655_ev_tab[][4]=
...
{ 
  ...
  uint8_t   	Reg0x3000,Reg0x3002,Reg0x3003;
   ...
   // uint32_t 		Gain_Mul = 0;
    ...
    {
    	msleep(50);
    	//printk("OV2655_CalculateExposureGain exit.\n");
         return ;
    }
...
//////////////////////////////////////////////////////////////////
    ...
    SENSOR_TRACE( "Reg0x3000=%d", Reg0x3000);
    SENSOR_TRACE("g_PV_Shutter=%d", g_PV_Shutter);
    SENSOR_TRACE("g_PV_Extra_Lines=%d", g_PV_Extra_Lines);
    SENSOR_TRACE( "PV_Line_Width=%d", PV_Line_Width);
    SENSOR_TRACE("Capture_Line_Width=%d", Capture_Line_Width);
    ...
    SENSOR_TRACE( "PV_Line_Width=%d", PV_Line_Width);
    SENSOR_TRACE("Capture_Line_Width=%d", Capture_Line_Width);
    SENSOR_TRACE("Capture_Maximum_Shutter=%d", Capture_Maximum_Shutter);
    SENSOR_TRACE( "Capture_Banding_Filter=%d", Capture_Banding_Filter);
    SENSOR_TRACE("g_PV_Gain16=%d", g_PV_Gain16);
    SENSOR_TRACE( "Gain_Exposure=%d", Gain_Exposure);

    //redistribute gain and exposure
    if (Gain_Exposure < Capture_Banding_Filter * 16)     // Exposure < 1/100/120
    {

    	SENSOR_TRACE("if (Gain_Exposure < Capture_Banding_Filter * 16)");
       ...
       if(Gain_Exposure<16){//exposure line smaller than 2 lines and gain smaller than 0x08 
            ...
            SENSOR_TRACE("Gain_Exposure<16 Capture_Gain16=%d", Capture_Gain16);
        }
        else
        {
            ...
            SENSOR_TRACE("Gain_Exposure<16 else---- Capture_Gain16=%d", Capture_Gain16);
        }
    }
    else 
    {

    		SENSOR_TRACE("if (Gain_Exposure < Capture_Banding_Filter * 16)  else--------");
...
//		
/******************************************************************************/
//align(4) const SENSOR_REG_T ov2655_sharpness_tab[][2]=
...
//		
/******************************************************************************/
//align(4) const SENSOR_REG_T ov2655_saturation_tab[][4]=
...
//		
/******************************************************************************/
//align(4) const SENSOR_REG_T ov2655_image_effect_tab[][4]=
...
//align(4) const SENSOR_REG_T ov2655_brightness_tab[][5]=
...
/******************************************************************************/
//__align(4) const SENSOR_REG_T ov2655_contrast_tab[][6]=
...
//__align(4) const SENSOR_REG_T ov2655_work_mode_tab[][3]=
