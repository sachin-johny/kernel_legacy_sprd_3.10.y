 ...
 ****************************************************************
 *
 *  Component:	VirtualLogix virtual video FE
 *
...
char* vvideo_ioc_name (unsigned int ioc);
    ...
    static int
vvideo_ioctl (struct inode* inode, struct file* file,
...
vvideo_dev_init (VVideoDev* vvideo_dev, int minor)
{
	 ...
	 */
    cls_dev = device_create(vvideo_class, NULL, MKDEV(VVIDEO_MAJOR, minor),
...
vvideo_dev_destroy (VVideoDev* vvideo_dev, int minor)
{
	 ...
	 */
    device_destroy(vvideo_class, MKDEV(VVIDEO_MAJOR, minor));
}
...
vvideo_module_cleanup (void)
{
	...
	device_destroy(vvideo_class, MKDEV(VVIDEO_MAJOR, 0));
    }
...
vvideo_module_init (void)
{
	 ...
	 */
    vvideo_dev0 = device_create(vvideo_class, NULL, MKDEV(VVIDEO_MAJOR, 0), NULL, "vvideo");
