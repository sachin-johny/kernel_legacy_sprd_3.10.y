 ...
 ****************************************************************
 *
 * Synopsis: NK Virtual Watchdog client driver
 *
 * Copyright (C) 2006, Jaluna SA. All Rights Reserved.
 *
 * Use of this product is contingent on the existence of an executed license
 * agreement between Jaluna or one of its sublicensee, and your organization,
 * which specifies this software's terms of use. This software is here defined
 * as Jaluna Intellectual Property for the purposes of determining terms of use
 * as defined within the license agreement.
 *
 * #ident  "@(#)vwatchdog-sf.c 1.1     08/03/10 Jaluna"
 *
 * Contributor(s):
 *   Pascal Piovesan <pascal.piovesan@jaluna.com> - Jaluna SA
 *   Chi Dat Truong <chidat.truong@jaluna.com> - Jaluna SA
 *
 ****************************************************************
 */
...
MODULE_AUTHOR("Pascal Piovesan <pascal.piovesan@vlx.com> - VirtualLogix");
