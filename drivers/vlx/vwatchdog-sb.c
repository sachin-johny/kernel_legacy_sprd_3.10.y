 ...
 *
 * Synopsis: Nano-Kernel Virtual Watchdog driver
 *
 * #ident  "@(#)osware-watchdog-sb-arm.c 1.4     06/09/20 Jaluna"
 *
 * Contributor(s):
...
MODULE_AUTHOR("Pascal Piovesan <pascal.piovesan@vlx.com> - VirtualLogix,\n\t"
	      "Vladimir Grouzdev <vladimir.grouzdev@vlx.com> - VirtualLogix,\n\t"
	      "Chi Dat Truong <chidat.truong@vlx.com> - VirtualLogix");
