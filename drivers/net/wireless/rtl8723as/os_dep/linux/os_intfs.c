...
_func_enter_;
	...
	registry_par->bBtFwSupport = _TRUE;
#endif
...
int netdev_open(struct net_device *pnetdev)
{
	...
	DBG_871X_LEVEL(_drv_always_, "wlan open start bup:%d\n", padapter->bup);
...
netdev_open_normal_process:
	...
	DBG_871X_LEVEL(_drv_always_, "wlan open success bup:%d\n", padapter->bup);
...
netdev_open_error:
	...
	DBG_871X_LEVEL(_drv_err_, "wlan open fail bup:%d\n", padapter->bup);
...
static int netdev_close(struct net_device *pnetdev)
{
	...
	DBG_871X_LEVEL(_drv_always_, "wlan close start\n");
...
/*	if(!padapter->hw_init_completed)
	...
	DBG_871X_LEVEL(_drv_always_, "wlan close success \n");
