...
#else
	report.rxdw0 = be32_to_cpu(prxstat->rxdw0);
	report.rxdw1 = be32_to_cpu(prxstat->rxdw1);
	report.rxdw2 = be32_to_cpu(prxstat->rxdw2);
	report.rxdw3 = be32_to_cpu(prxstat->rxdw3);
	report.rxdw4 = be32_to_cpu(prxstat->rxdw4);
	report.rxdw5 = be32_to_cpu(prxstat->rxdw5);
#endif
