...
extern void rtl8723a_sreset_init_value(_adapter *padapter);
extern void rtl8723a_sreset_reset_value(_adapter *padapter);
...
extern u8 rtl8723a_sreset_get_wifi_status(_adapter *padapter);
#endif
#endif
