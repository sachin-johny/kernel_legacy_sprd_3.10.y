...
//***************Gamma 2.2********************
	{LCM_SEND(2),{0x00,0x00}},
	{LCM_SEND(23),{21,0,0xE1,0x00,0x06,0x14,0x25,0x3d,0x4e,0x5a,0x8d,0x7c,0x91,0x75,0x64,0x7d,
		0x69,0x6e,0x67,0x5f,0x55,0x5c,0x02}},

	{LCM_SEND(2),{0x00,0x00}},
	{LCM_SEND(23),{21,0,0xE2,0x00,0x06,0x14,0x25,0x3d,0x4e,0x5a,0x8d,0x7b,0x91,0x75,0x64,0x7d,
		0x69,0x6e,0x67,0x5f,0x55,0x5c,0x02}},
//******************************************** 
//***************Gamma 2.5********************
	{LCM_SEND(2),{0x00,0x00}},
	{LCM_SEND(23),{21,0,0xE1,0x00,0x02,0x07,0x12,0x22,0x37,0x41,0x78,0x6b,0x85,0x7f,0x6b,0x82,
		0x6b,0x71,0x69,0x61,0x58,0x4c,0x00}},

	{LCM_SEND(2),{0x00,0x00}},
	{LCM_SEND(23),{21,0,0xE2,0x00,0x02,0x07,0x12,0x22,0x37,0x41,0x78,0x6b,0x85,0x7f,0x6b,0x82,
		0x6b,0x71,0x69,0x61,0x58,0x4c,0x00}},
//******************************************** 
	...
	{LCM_SEND(17),{15,0,0xCE,0x38,0x05,0x03,0x5E,0x00,0x00,0x00,0x38,0x04,0x03,0x5F,0x00,0x00,0x00}},
...
//		printk("lcd_otm80193a_mipi read power mode 0x0A value is 0x%x! , read result(%d)\n", read_data[0], read_rtn);
	...
	printk("lcd_otm8019a_mipi read power mode fail!0x0A value is 0x%x! , read result(%d)\n", read_data[0], read_rtn);
	mipi_eotp_set(1,1);
	return 0x0;
}
