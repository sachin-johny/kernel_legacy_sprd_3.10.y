		...
		uint16_t left, uint16_t top, uint16_t right, uint16_t bottom)
{
	...
	LCD_PRINT("hx8363_set_window: %d, %d, %d, %d\n",left, top, right, bottom);

	HX8363_SpiWriteCmd(0x2A);
...
static int32_t hx8363_read_id(struct panel_spec *self)
{
	...
	spi_read(&id);
	id &= 0xff;
	LCD_PRINT(" hx8363_read_id kernel id = %d\n",id);
...
static struct timing_rgb lcd_hx8363_rgb_spi_timing = {
	.hfp = 10,  /* unit: pixel */
	.hbp = 6,
	.hsync = 8,
	.vfp = 3, /*unit: line*/
...
static struct info_rgb lcd_hx8363_rgb_info = {
	...
	.timing = &lcd_hx8363_rgb_spi_timing,
	.bus_info = {
		.spi = &lcd_hx8363_rgb_spi_info,
	}
};

struct panel_spec lcd_hx8363_rgb_spi_spec = {
	.width = 480,
	.height = 854,
	.fps = 58,
	.type = LCD_MODE_RGB,
