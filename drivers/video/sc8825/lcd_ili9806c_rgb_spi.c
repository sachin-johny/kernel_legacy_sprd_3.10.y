...
static int32_t ili9806c_enter_sleep(struct panel_spec *self, uint8_t is_sleep)
{
	...
	if(is_sleep==1){
		...
		//Sleep Out
		ILI9806C_SpiWriteCmd(0x0011);
		mdelay(120);
		ILI9806C_SpiWriteCmd(0x0029);
		mdelay(20);
	}
...
struct panel_cfg lcd_ili9806c_rgb_spi = {
	/* this panel can only be main lcd */
	.dev_id = SPRDFB_MAINLCD_ID,
	.lcd_id = 0x9816,
	.lcd_name = "lcd_ili9806c_rgb_spi",
	.panel = &lcd_ili9806c_rgb_spi_spec,
};

static int __init lcd_ili9806c_rgb_spi_init(void)
{
	return sprdfb_panel_register(&lcd_ili9806c_rgb_spi);
}

subsys_initcall(lcd_ili9806c_rgb_spi_init);
