...
{
	u32 t = __raw_readl((const volatile void *)REG_SYST_VALUE);
	while (t != __raw_readl((const volatile void *)REG_SYST_VALUE))
		t = __raw_readl((const volatile void *)REG_SYST_VALUE);
	return t;
}
