...
static int ltr558_ps_enable(u8 gainrange)
{
        ...
        switch (gainrange) {
        case PS_RANGE1:
                setgain = MODE_PS_ACTIVE_GAIN1;
                break;
        case PS_RANGE2:
                setgain = MODE_PS_ACTIVE_GAIN4;
                break;
        case PS_RANGE4:
                setgain = MODE_PS_ACTIVE_GAIN8;
                break;
        case PS_RANGE8:
                setgain = MODE_PS_ACTIVE_GAIN16;
                break;
        default:
                setgain = MODE_PS_ACTIVE_GAIN8;
                break;
...
static int ltr558_als_enable(u8 gainrange)
{
        ...
        switch (gainrange) {
        case ALS_RANGE1_320:
                setgain = MODE_ALS_ACTIVE_GAIN1;
                break;
        case ALS_RANGE2_64K:
                setgain = MODE_ALS_ACTIVE_GAIN2;
                break;
        default:
                setgain = MODE_ALS_ACTIVE_GAIN1;
                break;
...
static int ltr558_reg_init(void)
{
        ...
        ltr558_i2c_write_1_byte(LTR558_ALS_MEAS_RATE, 0x01);
