...
#if defined (CONFIG_MACH_SP8810G_BRCM) || defined (CONFIG_MACH_SP6820G_RTL)
	if(value > 255)
		value = 255;
...
*/
	//open lcm backlight
#if defined (CONFIG_MACH_SC8810OPENPHONE) || defined (CONFIG_MACH_SP6820G_RTL) || defined (CONFIG_MACH_SP8810G_BRCM)
