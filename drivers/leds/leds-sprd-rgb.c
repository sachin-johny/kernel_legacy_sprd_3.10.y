...
static int __devinit sprd_rgbled_init(void)
{
	return platform_driver_register(&sprd_rgbled_driver);
}

static void sprd_rgbled_exit(void)
{
	platform_driver_unregister(&sprd_rgbled_driver);
}

module_init(sprd_rgbled_init);
module_exit(sprd_rgbled_exit);
