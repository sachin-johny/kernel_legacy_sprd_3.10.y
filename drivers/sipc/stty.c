...
#if defined(CONFIG_MACH_SP8830GEA) || defined(CONFIG_MACH_SP7730GGA) || defined(CONFIG_MACH_SP7731GGA_LC) || defined(CONFIG_MACH_SP7731GEA) || defined(CONFIG_MACH_SP7731GEA_LC) || defined(CONFIG_MACH_TSHARKWSAMSUNG)
...
#if 0//defined(CONFIG_MACH_SP8830GEA) || defined(CONFIG_MACH_SP7730GGA) || defined(CONFIG_MACH_SP7731GGA_LC) || defined(CONFIG_MACH_SP7731GEA) || defined(CONFIG_MACH_SP7731GEA_LC) || defined(CONFIG_MACH_TSHARKWSAMSUNG)
