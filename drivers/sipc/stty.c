...
static int stty_open(struct tty_struct *tty, struct file * filp)
{
    ...
    || defined(CONFIG_MACH_SP7715EA) || defined(CONFIG_MACH_SP7715EATRISIM) || defined(CONFIG_MACH_SP7715GA) || defined(CONFIG_MACH_X3542) || defined(CONFIG_MACH_SP7715GATRISIM)||defined(CONFIG_MACH_SP5735C1EA) || defined(CONFIG_MACH_SP5735C2EA) \
