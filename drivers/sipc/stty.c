...
#if defined(CONFIG_MACH_SP8830GEA) || defined(CONFIG_MACH_SP7730GGA) || defined(CONFIG_MACH_TSHARKWSAMSUNG)
...
static int stty_open(struct tty_struct *tty, struct file * filp)
{
 ...
 #if 0//defined(CONFIG_MACH_SP8830GEA) || defined(CONFIG_MACH_SP7730GGA) || defined(CONFIG_MACH_TSHARKWSAMSUNG)
