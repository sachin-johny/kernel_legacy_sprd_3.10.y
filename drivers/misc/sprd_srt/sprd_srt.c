...
static long srt_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)//for linux 3.0
//static int srt_ioctl(struct inode *inodep, struct file *filp, unsigned int cmd, unsigned long arg)
{
	int i,ret=-1;	
	switch (cmd) 
	{
