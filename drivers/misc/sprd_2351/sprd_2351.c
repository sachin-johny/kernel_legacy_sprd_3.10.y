...
#else 
#define GPIO_RF2351_POWER_CTRL 169 //defined(CONFIG_MACH_SP7715EA) || defined(CONFIG_MACH_SP7715EATRISIM) || defined(CONFIG_MACH_SP7715GA) || defined(CONFIG_MACH_X3542) || defined(CONFIG_MACH_SP7715GATRISIM)
#endif
