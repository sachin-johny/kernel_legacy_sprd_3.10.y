...
SPRD_AUDIO_POWER_SIMPLE_LDO(VCOM_BUF, "VCOM", 6, PMUR4_PMUR3, BIT(VCM_BUF_EN),
			    NULL, 0, 0);
SPRD_AUDIO_POWER_SIMPLE_LDO(VBO, "BG_IBIAS", 7, PMUR2_PMUR1, BIT(VBO_EN), NULL,
			    0, 0);
SPRD_AUDIO_POWER_LDO(MICBIAS, "BG_IBIAS", 8, PMUR4_PMUR3, BIT(MICBIAS_EN), NULL,
		     PMUR2_PMUR1, MICBIAS_V_MASK, MICBIAS_V, VMIC_VSEL_table, 0,
		     0);
SPRD_AUDIO_POWER_SIMPLE_LDO(AUXMICBIAS, "BG_IBIAS", 9, PMUR4_PMUR3,
			    BIT(AUXMICBIAS_EN), NULL, 0, 0);
SPRD_AUDIO_POWER_SIMPLE_LDO(HEADMICBIAS, "BG_IBIAS", 10, PMUR2_PMUR1,
